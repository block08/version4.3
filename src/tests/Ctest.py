...
class Game:
    ...
    def run(self):
        ...
        user_mark = getattr(shared_data, 'user3_mark', '03')
        ...
        while running:
            ...
            if stats.game_score == 15:
                ...
                user3 = getattr(shared_data, 'user3_mark', '03')
                likert = LikertScale(screen=self.screen, question=f"请{user3}按下键盘按键1到7评估任务难度:",
                                     position=(260, 400),
                                     size=(1400, 500),

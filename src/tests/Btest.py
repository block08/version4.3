...
class Game:
    ...
    def run(self):
        ...
        user_mark = getattr(shared_data, 'user2_mark', '02')
        ...
        while running:
            ...
            if action_pending:
                if not first_image_shown:
                    ...
                    if stats.game_score == 12:
                        t2, timestamp2 = game_drawing.random_painting(numbers[1], self, 12)
                        pygame.image.save(self.screen, f"{output_image_folder}/pre_screenshot1.png")
                    elif stats.game_score == 13:
                        t3, timestamp3 = game_drawing.random_painting(numbers[2], self, 13)
            ...
            if stats.game_score == 15:
                ...
                likert = LikertScale(screen=self.screen, question=f"请{user2}按下键盘按键1到7评估任务难度:",
                                     position=(260, 400),
                                     size=(1400, 500),
